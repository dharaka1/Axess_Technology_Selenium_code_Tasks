...
public class Test {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		File file=screen.getScreenshotAs(OutputType.FILE); //Output File to get Sceenshort
        ...
        User_name.sendKeys("Dharakasundar8@Gmail.com"); // It is passing the value the element 
        ...
        User_Click_Login.click(); // It clicking the Login Element
